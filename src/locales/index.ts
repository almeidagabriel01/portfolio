export const ptBR = {
  ...
  projects: {
    ...
    registraPreview: {
      windowLabel: "App Android · demonstração",
      eyebrow: "App Android · fluxo interativo",
      open: "Abrir ao vivo",
      close: "Fechar",
      previewNotice: "Demonstração ilustrativa do app. Clique para explorar.",
      coverTitle: "O registro continua sem sinal.",
      coverBody: "Do formulário no tablet à assinatura verificável, mesmo com a operação offline.",
      illustration: "Telas ilustrativas inspiradas no app real. Sem dados de cliente.",
      ...
      phoneData: "Dados",
      phoneReview: "Revisão",
      phoneConform: "Conforme",
      phoneOptional: "Adicionar observação…",
      phoneDraft: "Rascunho local",
      phoneNext: "Continuar",
      phoneRecords: "Registros",
      phoneTabs: ["Todos", "A assinar", "Rascunhos", "Concluídos"],
      phoneNew: "Novo",
      phoneSignature: "Assinatura e conteúdo conferidos neste dispositivo.",
      phoneStatus: "Estado",
      phoneSigned: "Assinado",
      phoneProtection: "Integridade",
      phoneDetails: "Ver detalhes",
    },
    groups: {
      trabalho: "Trabalho",
      estudo: "Estudos",
...
export const enUS = {
  ...
  projects: {
    ...
    registraPreview: {
      windowLabel: "Android app · demo",
      eyebrow: "Android app · interactive flow",
      open: "Open live",
      close: "Close",
      previewNotice: "Illustrative app demo. Click to explore.",
      coverTitle: "Records continue without a signal.",
      coverBody: "From the form on a tablet to a verifiable signature, even during offline work.",
      illustration: "Illustrative screens inspired by the real app. No client data.",
      ...
      phoneData: "Data",
      phoneReview: "Review",
      phoneConform: "Compliant",
      phoneOptional: "Add a note…",
      phoneDraft: "Local draft",
      phoneNext: "Continue",
      phoneRecords: "Records",
      phoneTabs: ["All", "To sign", "Drafts", "Completed"],
      phoneNew: "New",
      phoneSignature: "Signature and content verified on this device.",
      phoneStatus: "Status",
      phoneSigned: "Signed",
      phoneProtection: "Integrity",
      phoneDetails: "View details",
    },
    groups: {
      trabalho: "Work",
      estudo: "Studies",
